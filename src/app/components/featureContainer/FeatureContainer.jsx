...
function Feature({ IconComponent, title, description, circleColor }) {
    ...
    const whileInViewVariants = {
        ...
        visible: { scale: 1, opacity: 1, transition: { duration: 0.5, delay: 0.3 } }, // Ajusta el delay aquí
    };
...
function FeatureContainer() {
    return (
        <div className="flex justify-center items-center mx-5 md:mx-10 mt-10 h-full">
